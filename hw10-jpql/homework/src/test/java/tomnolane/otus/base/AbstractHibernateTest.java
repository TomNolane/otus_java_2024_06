package java.tomnolane.otus.base;

import static java.tomnolane.otus.demo.DbServiceDemo.HIBERNATE_CFG_FILE;
...
import java.tomnolane.otus.core.repository.DataTemplateHibernate;
import java.tomnolane.otus.core.repository.HibernateUtils;
import java.tomnolane.otus.core.sessionmanager.TransactionManagerHibernate;
import java.tomnolane.otus.crm.dbmigrations.MigrationsExecutorFlyway;
import java.tomnolane.otus.crm.model.Client;
import java.tomnolane.otus.crm.service.DBServiceClient;
import java.tomnolane.otus.crm.service.DbServiceClientImpl;
