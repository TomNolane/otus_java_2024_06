...
import tomnolane.otus.config.AppConfig1;
import tomnolane.otus.config.AppConfig2;
import tomnolane.otus.services.GameProcessor;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // AppComponentsContainer container = new AppComponentsContainerImpl("tomnolane.otus.config");
