...
<form method="post" action="/api/clients" id="new_client">
    ...
    <input type="text" id="name" name="name" placeholder="Jon" required>

    <label for="address">Street</label>
    <input type="text" id="address" name="address" placeholder="Lenina" required>

    <label for="phone">Phone</label>
    <input type="number" id="phone" name="phone" placeholder="79123456789" required>
